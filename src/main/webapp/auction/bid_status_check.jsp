...
<body>
	...
	<%
		try {
			...
			// query for user bid
			ResultSet user_bid = stmt.executeQuery("select bid_value from bids where bid_value = (select max(bid_value) from bids where username='"+username+"') and item_id='"+item_id+"'");
